        	...
        	<div class="contentArea">
                <div class="mainContainerArea">
                   ...
                   <div class="second_row">
                        ...
                        <div class="checkboxes">
                            <p class="checkboxStyle"><input type="checkbox" name="original_receipient" id="original_receipient" <?php if($fetch_biilinginfo['original_receipient']=="Original for Receipient"){ ?>checked<?php } ?> />&nbsp;&nbsp;Original for Receipient</p>
                            
                            <p class="checkboxStyle"><input type="checkbox" name="duplicate_suppliers" id="duplicate_suppliers" <?php if($fetch_biilinginfo['duplicate_suppliers']=="Duplicate for Supplier / Transporter"){ ?>checked<?php } ?> />&nbsp;&nbsp;Duplicate for Supplier / Transporter &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                            
                            <p class="checkboxStyle"><input type="checkbox" name="triplicate_suppliers" id="triplicate_suppliers" <?php if($fetch_biilinginfo['triplicate_suppliers']=="Triplicate for Supplier"){ ?>checked<?php } ?>  />&nbsp;&nbsp;Triplicate for Supplier &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                        </div>
                    </div>    
                   <div class="boxes">
                        <div class="first_box">
                            ...
                            <div class="width50">
                            	<p><input type="text" name="reverse_charge" id="reverse_charge" value="<?php echo $fetch_biilinginfo['reverse_charge']; ?>" readonly="readonly"></p>
                                <p><input type="text" name="invoice_no" id="invoice_no" value="<?php echo $fetch_biilinginfo['bill_no']; ?>" readonly="readonly"></p>
                                <p><input type="text" name="invoice_date" id="invoice_date" value="<?php echo $fetch_biilinginfo['invoice_date']; ?>" readonly="readonly"></p>
                        ...
                        <div class="second_box">
                            <table>
                                <tr><td><p class="checkboxStyle">Transportation Mode : </p></td><td><input type="text" name="transport_mode" id="transport_mode" value="<?php echo $fetch_biilinginfo['transport_mode']; ?>" readonly="readonly"></td></tr>
                                <tr><td><p class="checkboxStyle">Vehicle Number : </p></td><td><input type="text" name="vehicle_number" id="vehicle_number" value="<?php echo $fetch_biilinginfo['vehicle_number']; ?>" readonly="readonly"></td></tr>
                                <tr><td><p class="checkboxStyle">Date of Supply : </p></td><td><input type="text" name="date_supply" id="date_supply" value="<?php echo $fetch_biilinginfo['date_supply']; ?>" readonly="readonly"></td></tr>
                                <tr><td><p class="checkboxStyle">Place of Supply : </p></td><td><input type="text" name="place_supply" id="place_supply" value="<?php echo $fetch_biilinginfo['place_supply']; ?>" readonly="readonly"></td></tr>
                            </table>
                        </div>
                    </div>
                    <div class="boxes">
                ...
                <div class="bottom_row">
                    ...
                    <div class="tax_row">
                        ...
                        <div class="signature">
                            <strong><b>Shri Shendhuren Electro Plating,</b></strong><br /><br /><br />
