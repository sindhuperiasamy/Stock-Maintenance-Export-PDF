...
<title>Payment Mode | Sri Shendhuren Electro Plating</title>
              ...
              <tbody>
                ...
                while($fetch_inward = mysqli_fetch_array( $result_inward )){?>
                    ...
                    $fetch_client = mysqli_fetch_array( $result_client ); ?>
                      ...
                      <td><?php echo $fetch_inward['payment_mode']; ?></td>
                      <td><?php echo $fetch_inward['payment_number']; ?></td>
                      <td class="center"><a href="view_payment_mode.php?view=<?php echo $fetch_inward['id']; ?>">View</a> | <a href="payment_mode.php?del=<?php echo $fetch_inward['id']; ?>">Delete</a></td>
                    </tr><?php
